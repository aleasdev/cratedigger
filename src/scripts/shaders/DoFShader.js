...
const DoFShader = {
    ...
    uniforms: {
        ...
        "textel": { value: new Vector2(1 / 512, 1 / 512) },
        "focalDepth": { value: 200.0 },
        "focalLength": { value: 28.0 },
        "fstop": { value: 2.8 },
        "showFocus": { value: 0 },
        "manualdof": { value: 0 },
        "ndofstart": { value: 1.0 },
    ...
    fragmentShader: [
        ...
        "uniform vec2 textel;", // textel size
        ...
        */
        ...
        "vec2 wh = vec2(textel.x, textel.y) * dbsize;",
        ...
        "col.r = texture2D(tDiffuse,coords + vec2(0.0,1.0)*textel*fringe*blur).r;",
        "col.g = texture2D(tDiffuse,coords + vec2(-0.866,-0.5)*textel*fringe*blur).g;",
        "col.b = texture2D(tDiffuse,coords + vec2(0.866,-0.5)*textel*fringe*blur).b;",
